    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="object-cover rounded-full shadow-xl h-60 w-60"
            />
          </motion.div>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/deshani-palliyaguruge-42a18224b?jobid=1234&lipi=urn%3Ali%3Apage%3Ad_jobs_easyapply_pdfgenresume%3BFSak0dJzQRy8JkYobgtQQw%3D%3D&licu=urn%3Ali%3Acontrol%3Ad_jobs_easyapply_pdfgenresume-v02_profile"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/deshanipalliyaguruge"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
        ...
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://medium.com/@deshanipalliyaguruge2000"
          target="_blank"
        >
          <FaMedium />
        </a>
